...
Anterior: 2026-06-26 (feature `pets/` + gate de pets no shell do tutor: `TutorRoot` no `MainNavigator`, flag `petagil-has-pet:<userId>` em AsyncStorage, `PetCadastroScreen` em `screens/tutor/`)
